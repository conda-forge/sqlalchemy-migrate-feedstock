About sqlalchemy-migrate-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlalchemy-migrate-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/openstack/sqlalchemy-migrate

Documentation: https://sqlalchemy-migrate.readthedocs.io/en/latest/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4979&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-migrate-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-migrate` can be installed with `conda`:
...
```
mamba install sqlalchemy-migrate
```

It is possible to list all of the versions of `sqlalchemy-migrate` available on your platform with `conda`:
...
```
mamba search sqlalchemy-migrate --channel conda-forge
```
...
mamba repoquery search sqlalchemy-migrate --channel conda-forge

# List packages depending on `sqlalchemy-migrate`:
mamba repoquery whoneeds sqlalchemy-migrate --channel conda-forge

# List dependencies of `sqlalchemy-migrate`:
mamba repoquery depends sqlalchemy-migrate --channel conda-forge
```
